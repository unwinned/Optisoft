...
(() => {
        ...
        if ((t && typeof t == "object") || typeof t == "function")
            for (let r of Ue(t))
                !Ne.call(e, r) &&
                    ...
                    U(e, r, {
                        get: () => t[r],
                        enumerable: !(o = qe(t, r)) || o.enumerable,
                    });
        return e;
    };
    var Y = (e, t, n) => (
    ...
    var le = X((Mt, j) => {
        ...
        c.prototype.emit = function (t) {
            ...
            if (typeof g == "function") Z(g, this, n);
            else
                for (var p = g.length, C = ie(g, p), o = 0; o < p; ++o)
                    Z(C[o], this, n);
            return !0;
        };
        function oe(e, t, n, o) {
        ...
        c.prototype.once = function (t, n) {
            return P(n), this.on(t, re(this, t, n)), this;
        };
        c.prototype.prependOnceListener = function (t, n) {
            return P(n), this.prependListener(t, re(this, t, n)), this;
        };
        ...
        function Je(e, t) {
            return new Promise(function (n, o) {
                ...
                ce(e, t, a, { once: !0 }),
                    t !== "error" && Xe(e, r, { once: !0 });
            });
        }
        function Xe(e, t, n) {
            typeof e.on == "function" && ce(e, "error", t, n);
        }
        function ce(e, t, n, o) {
    ...
    var Ye = (() => {
        ...
        pe = 4096;
    function de() {
        (N === void 0 || B + 16 > pe) && ((B = 0), (N = Ye(pe)));
        let e = Array.prototype.slice.call(N, B, (B += 16));
        return (
            (e[6] = (e[6] & 15) | 64),
            (e[8] = (e[8] & 63) | 128),
            l[e[0]] +
    ...
    var Ze = {
        ...
        K = (e) => Ze[typeof e](e),
        S = class extends ue.EventEmitter {
            constructor(t) {
                super(),
                    ...
                    let i = [],
                        g = (p) => {
                            if (p !== void 0 && p._chunkSplit) {
                                let C = p._chunkSplit;
                                (i = [...i, ...p.data]),
                                    C.lastChunk && (this.off(r, g), a(i));
                            } else this.off(r, g), a(p);
                        };
                    this.on(r, g);
                    try {
                        let p = t.map((C) => ({
                            ...C,
                            payload: { data: C.payload, eventResponseKey: r },
                        }));
                        this.wall.send(p);
                    } catch (p) {
                        let C =
                        ...
                        if (p.message === C && Array.isArray(n.payload)) {
                            ...
                            if (T > this._maxMessageSize) {
                                let b = Math.ceil(T / this._maxMessageSize),
                                    y = Math.ceil(n.payload.length / b),
                                    H = n.payload;
                                for (let k = 0; k < b; k++) {
                                    let q = Math.min(H.length, y);
                                    this.wall.send([
                                        {
                                            event: n.event,
                                            payload: {
    ...
    var Ee = Y(ge());
    var et = chrome.runtime.getURL("assets/config.js"),
        me,
        W = (me = globalThis.browser) != null ? me : globalThis.chrome;
    async function tt() {
        var G, Q;
        let e = await W.storage.local.get("defaultConfig");
        if ((G = e.defaultConfig) != null && G.apiKey) return e.defaultConfig;
        let t = {},
            n = ["DelayTime", "RepeatTimes", "port"],
            o = ["enabledFor", "useCapsolver", "manualSolving", "useProxy"],
            r = /\/\*[\s\S]*?\*\/|([^:]|^)\/\/.*$/gm,
            i = (await (await fetch(et)).text()).replace(r, ""),
            g = i.slice(i.indexOf("{") + 1, i.lastIndexOf("}")),
            p = JSON.stringify(g)
                .replaceAll('\\"', "'")
                .replaceAll("\\n", "")
                .replaceAll('"', "")
        ...
        p
            ...
            .forEach((Oe) => {
                let [E, J] = Oe.split(":");
                if (E && J) {
                    let M = J.replaceAll("'", "").replaceAll('"', "");
                    for (let v = 0; v < n.length; v++)
                        E.endsWith(n[v]) && (M = Number(M));
                    for (let v = 0; v < o.length; v++)
                        E.startsWith(o[v]) && (M = M === "true");
                    t[E] = M;
                }
            }),
            (y = y.replaceAll("'", "").replaceAll('"', ""));
        let q = y.indexOf(":["),
            Fe = y.slice(q + 2, y.length - 1);
        t.blackUrlList = Fe.split(",");
        let I = await W.storage.local.get("config");
        return (
            (Q = I == null ? void 0 : I.config) != null &&
                Q.apiKey &&
                (t.apiKey = I.config.apiKey),
    ...
    async function Ce() {
        let e = await tt(),
            t = Object.keys(e);
        for (let n of t)
            if (!(n === "proxyType" && !he[n].includes(e[n]))) {
                {
                    if (n.endsWith("Mode") && !he.mode.includes(e[n])) continue;
                    if (n === "port") {
    ...
    var nt = Ce(),
        f = {
            ...
            async getAll() {
                ...
                return f.joinConfig(e, t.config);
            },
            async set(e) {
                let t = await f.getAll(),
                    n = f.joinConfig(t, e);
    ...
    function ve() {
        ...
        e ||
            ((e = document.createElement("capsolver-widgets")),
            ...
            (window.setCaptchaWidgetDataset = (t, n, o) => {
                let r;
                t
                    ? (r = `capsolver-widget[data-widget-id="${t}"]`)
                    : (r = "capsolver-widget");
    ...
    var _ = class {
        ...
        getParams(t, n) {
            return { url: location.href, sitekey: t.sitekey };
        }
        onSolved(t, n) {
            u(chrome.i18n.getMessage("solved"), "solved");
            let o = document.getElementById(t.containerId);
            if (!o) return;
            o.querySelectorAll("iframe[data-hcaptcha-widget-id]").forEach(
                (a) => {
                    ...
                    window.dispatchEvent(
                        new MessageEvent("message", { data: i })
                    );
                }
            );
        }
    ...
    var D = class {
        ...
        setSolveButton(t, n) {
            ...
            r.textarea && r.textarea.parentElement
                ? ((r.textarea.parentElement.style.height = "auto"),
                  r.textarea.parentElement.insertBefore(
                      o,
                      r.textarea.nextSibling
                  ))
        ...
        getParams(t, n) {
            return {
                ...
                invisible: t == null ? void 0 : t.invisible,
        ...
        getBindedElements(t) {
            ...
            if (t.bindedButtonId) {
                ...
                let o = document.querySelector(
                    `#${t.containerId} textarea[name=g-recaptcha-response]`
                );
                o && (n.textarea = o);
            }
            return n;
    ...
    var be = 304;
    function it(e) {
        return e - be > 0 ? (e - be) / 2 : 0;
    }
    var A = class {
        constructor() {
            h(this, "captchaType", st);
        }
        setSolveButton(t, n) {
            let o = document.querySelector("#" + t.containerId),
                r = n;
            (r.style.width = o.querySelector("iframe").offsetWidth + "px"),
                ...
                (r.style.left =
                    it(o.querySelector("iframe").offsetWidth) + "px"),
                (r.style.bottom = "20px"),
                o.append(r);
        }
        getParams(t) {
    ...
    function lt() {
        ...
        return t
            .slice(t.indexOf("turnstile"))
            .sort((o, r) => r.length - o.length)[0];
    }
    var F = class {
        constructor() {
            h(this, "captchaType", ct);
        }
        getParams(t, n) {
            return {
                websiteURL: location.href,
    ...
    function we(e) {
        m.register(new _()),
            m.register(new D("reCaptcha")),
            m.register(new D("reCaptcha3")),
            m.register(new A()),
            m.register(new F()),
            m.register(new O());
    }
        ...
        if (e != null && e.response) {
            ...
            switch (t) {
                case "solver":
                    ...
                    break;
                case "solved":
                    u(chrome.i18n.getMessage("solved"), "solved"), Le();
                    break;
            }
        }
    }
    function dt(e) {
        var t;
        try {
            if ((t = e.request) != null && t.messageId) return ft(e);
            let n = {
            ...
            e.error
                ? (f.getAll().then((o) => {
                      e.error === "Error: Capsover: No API Kye set up yet!" &&
                          !(o != null && o.apiKey) &&
                          u("Please input your API key!", "error"),
                          o[`${n.captchaType}RepeatTimes`] >= xe
    ...
    function ut(e) {
        let t = window.getCaptchaWidgetDataset(
                e.request.captchaType,
                e.request.widgetId
            ),
    ...
    function Le() {
        f.getAll().then((e) => {
            window.postMessage(
                { type: "capsolverCallback", callback: e.solvedCallback },
                "*"
            );
        });
    }
    function ft(e) {
        ...
        !t ||
            (e.error
                ? Te(t[0], { error: e.error })
                : Te(t[0], { response: e.response.code }));
    }
    function Te(e, t) {
            ...
            (window.onTaskByToken = (e) => {
                ...
                f.getAll().then((r) => {
                    ...
                    window.setCaptchaWidgetDataset(n, "status", "processing"),
                        chrome.runtime.sendMessage(i).then(Se);
                });
            });
    }
    var ht = (e, t) => {
    ...
    function ke() {
        return setInterval(async () => {
            ...
            for (let n = 0; n < t.length; n++) {
                ...
                if (!(e != null && e.apiKey)) {
                    We(r), u("Please input your API key!", "error");
                    return;
                }
                !ht(e, r) ||
                    r.status !== "ready" ||
                    (e.manualSolving
                        ? gt(r, e[`${r.captchaType}Mode`])
                        : e[`${r.captchaType}Mode`] === "token" &&
                          window.onTaskByToken(r));
            }
        }, 2e3);
    }
    var Re = document.createElement("script");
    Re.src = chrome.runtime.getURL("assets/inject/solvedCallback.js");
    var mt = document.head || document.documentElement;
    mt.appendChild(Re);
    var Pe = [],
        Ct = [
            "arkoselabs.com/fc",
        ...
        yt = chrome.runtime.connect({ name: "content" });
    yt.onDisconnect.addListener((e) => {
        for (let t of Pe) t && clearInterval(t);
    });
    var Ie,
        vt = (Ie = globalThis.browser) != null ? Ie : globalThis.chrome;
    vt.storage.local.set({
    ...
    chrome.runtime.onMessage.addListener((e, t, n) => {
        ...
        let o =
                (a = e == null ? void 0 : e.response) == null
                    ...
                    : a.action,
            r =
                (s = e == null ? void 0 : e.response) == null
                    ? void 0
                    : s.callback;
        switch (o) {
            case "solved":
                u(chrome.i18n.getMessage("solved"), "solved"),
                    window.postMessage(
                        { type: "capsolverCallback", callback: r },
                        "*"
                    );
                break;
            default:
    ...
    function wt() {
        try {
            ...
            chrome.runtime.sendMessage({
                ...
                metadata: { pageURL: e, title: t },
            });
        } catch {}
    }
    f.getAll().then(function (e) {
        ve(), we(e), De();
        let t = window.location.origin,
            n = window.location.pathname,
            o = t + n,
            r = Ct.some((s) => o.indexOf(s) !== -1),
            a = e.blackUrlList.includes(o);
        f.set({ isInBlackList: r ? e.isInBlackList : a, isInit: !0 }).then(
            () => {
                (!e.enabledForBlacklistControl || !a) &&
                    e.useCapsolver &&
                    (Pe.push(ke()), bt(), wt());
            }
        );
    });
    var Be = (0, Ee.bexContent)((e) => {
        ye(e);
    });
    ...
    document instanceof HTMLDocument && xt(chrome.runtime.getURL("dom.js"));
    fe(Ae, "bex-dom");
    Be(Ae);
})();
